...
def main():
    ...
    model = models.init_model(name=args.arch, num_classes=dataset.num_train_vids, loss={'softmax','metric'}, use_gpu=use_gpu)
        ...
        if (batch_idx+1) % args.print_freq == 0:
            print('Epoch: [{0}][{1}/{2}]\t'
                  ...
                  'MLoss {htri_loss.val:.4f} ({htri_loss.avg:.4f})\t'.format(
                   ...
                   loss=losses,xent_loss=xent_losses, htri_loss=htri_losses))
